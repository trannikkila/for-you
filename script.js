...
function setScene2BubbleText(text) {
  bubbleTextScene2.innerHTML = text;
}

function setScene3BubbleText(text) {
  bubbleTextScene3.innerHTML = text;
}

function setScene4BubbleText(text) {
  bubbleTextScene4.innerHTML = text;
}

function setScene5BubbleText(text) {
  bubbleTextScene5.innerHTML = text;
}
...
function startScene2Dialogue() {
  ...
  setTimeout(() => {
    setScene2BubbleText("Oh! Hiiii you!");
  }, 3000);
  ...
  setTimeout(() => {
    setScene2BubbleText("but I’m really glad it was you who found me");
  }, 11500);
...
function startScene3Dialogue() {
  ...
  setTimeout(() => {
    setScene3BubbleText("Yeah, I didn’t have much time to think of something cooler…");
  }, 3500);
...
function showPurplePart1() {
  setScene4BubbleText(
    "This one is special, it feels deeper the more you look at it.<br>Kind of like you, every new piece, gives me a reason.<br>to admire you more<span class='next-inline' id='purple-next-1'>Next</span>"
  );
...
function showPurplePart2() {
  setScene4BubbleText(
    "And in the way that feels right, you have made me let go of my defenses I didn’t I didn’t realize were there<span class='next-inline' id='purple-next-2'>Next</span>"
  );
...
function handleFlowerClick(flowerName, flowerElement) {
  ...
  if (flowerName === "yellow") {
    collectedBaseFlowers += 1;
    setScene4BubbleText("Oh...this flower shines so brightly...<br>I couldn’t help but smile when I saw it, because it reminds me of how moments with you feels lighter and more special");
  }
...
function startScene5Dialogue() {
  ...
  setTimeout(() => {
    setScene5BubbleText("I find myself thinking of you often, miss you I will be around dear, always");
